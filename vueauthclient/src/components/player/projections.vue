<template>
  <div id="wrapper" class="max-w-xl px-4 py-4 mx-auto">
    ...
    >
      <div
        class="flex group  rounded-lg mx-1 transition-all duration-300 cursor-pointer justify-center w-16"
        v-bind:class="{'bg-purple-600 shadow-lg dark-shadow':day.today, 'hover:bg-purple-500 hover:shadow-lg hover-dark-shadow':!day.today}"
        v-for="(day, i) in gameDays" :key="i"
      >
